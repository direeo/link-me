      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-6 pt-40 pb-32 md:pt-52 md:pb-48 text-center">
        ...
        <div className="mt-16 flex items-center gap-6 text-slate-600">
          <div className="flex -space-x-3">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className={`w-9 h-9 rounded-full border-2 border-[#050508] bg-slate-800 flex items-center justify-center text-[10px] font-bold px-4`}>
                User
              </div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px]">
            ...
            <div className="md:col-span-8 glass-card rounded-[2.5rem] p-10 flex flex-col justify-end relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <div className="w-12 h-12 rounded-2xl bg-violet-500/10 border border-violet-500/20 flex items-center justify-center mb-6 text-2xl">🧠</div>
            ...
            <div className="md:col-span-4 glass-card rounded-[2.5rem] p-10 flex flex-col justify-between border-indigo-500/20">
               <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center mb-6 text-2xl">💬</div>
                <div>
            ...
            <div className="md:col-span-4 glass-card rounded-[2.5rem] p-10 flex flex-col justify-between border-cyan-500/20">
               <div className="w-12 h-12 rounded-2xl bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center mb-6 text-2xl">📈</div>
                <div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <div className="glass-panel rounded-[2.5rem] p-10 border-white/5 relative group">
              ...
              <Button variant="outline" className="w-full py-6 uppercase tracking-widest text-[10px]" onClick={() => window.location.href = '/signup'}>
                Access Framework
              </Button>
            </div>
            ...
            <div className="glass-panel rounded-[2.5rem] p-10 border-violet-500/40 bg-violet-600/[0.03] relative overflow-hidden premium-glow-violet group">
              ...
              <Button variant="primary" className="w-full py-6 grayscale opacity-50 cursor-not-allowed uppercase tracking-widest text-[10px]">
                Waitlist Only
              </Button>
            </div>
          </div>
      ...
      <footer className="relative z-10 px-6 py-20 border-t border-white/5 bg-[#050508]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-16">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-12">
             ...
             <div className="space-y-4">
                ...
                <ul className="space-y-2">
                   <li><Link href="/privacy" className="text-xs font-bold text-slate-400 hover:text-violet-400 transition-colors">Privacy</Link></li>
                   <li><Link href="/terms" className="text-xs font-bold text-slate-400 hover:text-violet-400 transition-colors">Terms</Link></li>
                </ul>
             </div>
             <div className="space-y-4">
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500">Support</span>
                <ul className="space-y-2">
                   <li><a href="mailto:hello@linkme-ai.com" className="text-xs font-bold text-slate-400 hover:text-violet-400 transition-colors">Contact Support</a></li>
                </ul>
             </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-[10px] font-black uppercase tracking-widest text-slate-700">
            © 2026. REFRAMING GLOBAL LEARNING.
          </p>
          <div className="flex items-center gap-6">
             <span className="text-[10px] font-black uppercase tracking-widest text-slate-700">Standardized Mastery Platforms.</span>
          </div>
        </div>
      </footer>
    </div>
