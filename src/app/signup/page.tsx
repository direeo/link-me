            ...
            <div className="w-full max-w-md relative z-10 animate-in fade-in zoom-in-95 duration-700">
                ...
                <div className="glass-panel rounded-[40px] p-8 md:p-12 relative overflow-hidden transition-all duration-700 animate-in fade-in zoom-in-95">
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-[10px] uppercase font-bold tracking-widest">
                            <span className="px-4 text-slate-600 bg-transparent">Or try without signing up</span>
                        </div>
                    </div>
                ...
                <div className="text-center mt-10">
                    <p className="text-[10px] font-bold text-slate-800 uppercase tracking-widest leading-relaxed">
                        ...
                        <Link href="/terms" className="text-slate-600 hover:text-white underline">Terms of Service</Link>
                        {' '}and{' '}
                        <Link href="/privacy" className="text-slate-600 hover:text-white underline">Privacy Policy</Link>
                    </p>
                </div>
            </div>
        </div>
